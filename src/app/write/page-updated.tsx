...
export const metadata = {
  title: "Bac Excellence - La Plateforme Officielle BAC Tunisie",
  description: "La seule plateforme IA conçue pour le Baccalauréat Tunisien. Prépare ton BAC 2026 avec des examens officiels, corrections IA réalistes, et contenu adapté à ta section.",
  keywords: "BAC Tunisie, Bac Excellence, examens BAC 2026, correction IA, anglais BAC, français BAC, arabe BAC",
  openGraph: {
    title: "Bac Excellence - Obtenez la Mention Très Bien",
    description: "Rejoignez 50,000+ élèves tunisiens qui utilisent Bac Excellence pour réussir leur BAC.",
    type: "website",
    locale: "fr_TN",
  ...
  twitter: {
    ...
    description: "La plateforme IA officielle du BAC Tunisien",
    images: ["/og-image.jpg"]
  }
};
