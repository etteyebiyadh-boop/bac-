...
function labels(lang: SiteLanguage) {
  ...
  if (lang === "ar") {
    return {
      title: "تشخيص اللغات 🚀",
      subtitle: "جاوب على شوية أسئلة باش نعطيوك مستواك وخارطة الطريق متاعك بالصحيح.",
      section: "الشعبة",
      intro: "اختار لغة، كمل التيست الصغير، وابدا الدروس اللي تحاججك توا.",
      question: "سؤال",
      submit: "احسبلي مستواي توا! 🔥",
      changeLanguage: "بدّل اللغة",
      result: "النتيجة",
      ...
      retry: "نعاود التيست",
      diagnosticMissing: "ما فما حتى نتيجة لهنا.",
      startRoadmap: "ابدا الـ Roadmap توا",
      library: "افتح المكتبة",
      saveNote: "النتيجة تتسجل لهنا وتطلع لك في الـ Dashboard متاعك."
    };
  }
