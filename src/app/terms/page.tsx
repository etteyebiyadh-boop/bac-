export default function TermsPage() {
  return (
    <div className="card stack">
      ...
      <p>
        Free plans include limited corrections. Premium access and pricing can change with prior
        notice.
      </p>
      <p>
        Users must not abuse the platform, attempt unauthorized access, or submit illegal content.
      </p>
    </div>
  );
}
